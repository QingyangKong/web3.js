...
var inputTransactionFormatterCita = function (options){
    console.log("transaction parameter options: " + JSON.stringify(options));
...
module.exports = {
    ...
    inputTransactionFormatterCita: inputTransactionFormatterCita,
