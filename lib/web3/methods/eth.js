...
var blockCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? "cita_getBlockByHash" : "cita_getBlockByNumber";
};
