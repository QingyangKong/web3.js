...
// web3.eth.getBlock(9, function (err, result) {
//     if (err) {
//         //error info
//         console.log("error = " + err);
//     } else {
...
// web3.eth.getBlock(height_hash, function (err, result) {
//     if(err) {
//         //error info
//         console.log("error = " + err);
//     } else {
...
// web3.eth.getTransaction(height_hash, function (err, result) {
//     if (err) {
//         //error info
//         console.log("error = " + err);
//     } else {
...
// web3.eth.getTransactionReceipt(height_hash, function (err, result) {
//     if (err) {
//         //error info
//         console.log("error = " + err);
//     } else {
